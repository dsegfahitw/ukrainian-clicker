...
export const bosses: Boss[] = [
  {
    ...
    requirementsText: ["Репутація ≥ 30"],
    reward: {
      money: 1500,
      experience: 200,
      permanent: "unlock_small_business",
      description: "+₴1,500, +200 XP, відкриття малого бізнесу",
    },
    color: "#8B6914",
  },
  {
    ...
    requirements: { money: 50000, stage: 2 },
    requirementsText: ["Гроші ≥ ₴50,000", "Стадія ≥ 2 (Райцентр)"],
    reward: {
      money: 7000,
      experience: 500,
      passiveBonus: 0.25,
      permanent: "passive_boost_25",
      description: "+₴7,000, +500 XP, +25% до пасивного доходу назавжди",
    },
    color: "#4169E1",
  },
  {
    ...
    requirements: { skill: { id: "marketing", level: 3 } },
    requirementsText: ["Маркетинг ≥ рівень 3"],
    reward: {
      money: 8000,
      experience: 800,
  ...
  },
  {
    ...
    requirements: { corruption: 50 },
    requirementsText: ["Корупція ≥ 50"],
    reward: {
      money: 12000,
      experience: 1500,
      permanent: "political_influence",
      description: "+₴12,000, +1500 XP, Політичний вплив — новий навик і події",
    },
    color: "#E74C3C",
  },
  {
    ...
    requirementsText: ["Стадія 5 (Еліта)"],
    reward: {
      money: 100000,
      experience: 5000,
      passiveBonus: 0.5,
